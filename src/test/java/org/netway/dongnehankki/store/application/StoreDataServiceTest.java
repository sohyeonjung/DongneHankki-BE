...
//
// 	private GMStoreOpenApiResponse.Row validRow;
// 	private GMStoreOpenApiResponse.Row invalidNullFieldRow;
// 	private GMStoreOpenApiResponse.Row invalidClosedRow;
// 	private GMStoreOpenApiResponse.Row invalidInduTypeRow;
// 	private GMStoreOpenApiResponse.Row invalidBlankInduTypeRow;
// 	private GMStoreOpenApiResponse.Row fullyNullRow;
// 	private Store existingStore;
//
// 	@BeforeEach
// 	void setUp() {
// 		fullyNullRow = new GMStoreOpenApiResponse.Row();
//
// 		validRow = new GMStoreOpenApiResponse.Row();
...
//
//
// 		invalidNullFieldRow = new GMStoreOpenApiResponse.Row();
...
//
//
// 		invalidClosedRow = new GMStoreOpenApiResponse.Row();
...
//
//
// 		invalidInduTypeRow = new GMStoreOpenApiResponse.Row();
...
//
// 		invalidBlankInduTypeRow = new GMStoreOpenApiResponse.Row();
...
// 		// Given
// 		List<GMStoreOpenApiResponse.Row> rows = Arrays.asList(fullyNullRow, invalidNullFieldRow, validRow);
//
...
// 		// Given
// 		GMStoreOpenApiResponse.Row rowWithNullLeadTaxManStateCd = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullCmpnmNm = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullLat = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullLogt = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullAddr = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullSigun = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullIndu = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row rowWithNullBiz = new GMStoreOpenApiResponse.Row();
...
//
//
// 		List<GMStoreOpenApiResponse.Row> rows = Arrays.asList(
...
// 		// Given
// 		List<GMStoreOpenApiResponse.Row> rows = Arrays.asList(invalidClosedRow, validRow);
//
// 		when(storeRepository.findByBusinessRegistrationNumber(Long.valueOf(validRow.getBizregno()))).thenReturn(Optional.empty());
// 		when(storeRepository.save(any(Store.class))).thenReturn(any(Store.class));
//
...
// 		// Given
// 		List<GMStoreOpenApiResponse.Row> rows = Arrays.asList(invalidBlankInduTypeRow, validRow);
//
// 		when(storeRepository.findByBusinessRegistrationNumber(Long.valueOf(validRow.getBizregno()))).thenReturn(Optional.empty());
// 		when(storeRepository.save(any(Store.class))).thenReturn(any(Store.class));
//
...
// 		// Given
// 		List<GMStoreOpenApiResponse.Row> rows = Arrays.asList(invalidInduTypeRow, validRow);
//
// 		when(storeRepository.findByBusinessRegistrationNumber(Long.valueOf(validRow.getBizregno()))).thenReturn(Optional.empty());
// 		when(storeRepository.save(any(Store.class))).thenReturn(any(Store.class));
//
...
// 		// Given
// 		GMStoreOpenApiResponse.Row newStoreRow = new GMStoreOpenApiResponse.Row();
...
//
// 		GMStoreOpenApiResponse.Row updatedStoreRow = new GMStoreOpenApiResponse.Row();
...
//
// 		List<GMStoreOpenApiResponse.Row> apiRows = Arrays.asList(newStoreRow, updatedStoreRow, invalidClosedRow);
//
